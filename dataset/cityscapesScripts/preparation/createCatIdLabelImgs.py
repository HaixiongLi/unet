...
from preparation.json2catImg import json2labelImg
...
def main():
    ...
    if 'CITYSCAPES_DATASET' in os.environ:
        ...
        # cityscapesPath = os.environ['/media/lab2/机械盘1/Dataset/cityscapes/dataset/']
        # cityscapesPath = '/media/lab2/机械盘1/Dataset/cityscapes/dataset/'
    else:
        # cityscapesPath = os.path.join(os.path.dirname(os.path.realpath(__file__)),'..','..')
        cityscapesPath = '/media/lab2/机械盘1/Dataset/cityscapes/datasets/'
    ...
    for f in files:
        ...
        dst = f.replace( "_polygons.json" , "_labelCatIds.png" )

        # do the conversion
        try:
            json2labelImg( f , dst , "catIds" )
        except:
